...
estimate_data = np.load('../data/output/20240415_172120_rgb.npy')
gt_data = np.load('../data/input/food_dataset/20240415/popcorn_chicken/172120/depth_in_millimeters.npy')
...
plt.imsave('normalized_esti_depth_map.png', normalized_gt_data, cmap='gray')
plt.imsave('normalized_gt_depth_map.png', normalized_estimate_data, cmap='gray')
